...
async function fetchDexSwap(){
  const allowance = await axios.get(`https://api.1inch.io/v5.0/1/approve/allowance?tokenAddress=${tokenOne.adress}&walletAddress=${address}`)
...
fetchPrices(tokenList[0].address, tokenList[1].address)
 ...
 useEffect(()=>{
  ...
  return (<>
   ...
   <div className="modalContent">{tokenList?.map((e,i)=>{
    return (
